---
description: >-
  Your UI/UX folder place any shared components here, This folder contains every
  single re-usable component such as button colour, card type, icon or anything
  else
---
